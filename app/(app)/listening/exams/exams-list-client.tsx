  ...
  return (
    <div style={{ background: c.background, color: c.onSurface, minHeight: "100vh" }}>
      <main style={{ padding: "24px 24px 128px", maxWidth: 448, margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 700, color: c.primary, letterSpacing: "-0.025em", margin: 0 }}>
          Oefenexamens
        </h1>
                  ...
                  {completed && (
                    <div style={{
                      ...
                      <span style={{ fontSize: 12, fontWeight: 700, color: c.onSurfaceVariant }}>
                        Beste score: <span style={{ color: exam.passed ? c.primary : c.error, fontWeight: 700 }}>{exam.bestScore}%</span>
                        {" · "}{exam.attempts} pogingen
                      </span>
                      <span style={{
                        padding: "4px 10px", borderRadius: 9999, fontSize: 10, fontWeight: 700,
                        textTransform: "uppercase", letterSpacing: "0.05em",
                        background: exam.passed ? `${c.coSoft}` : `${c.rdSoft}`,
