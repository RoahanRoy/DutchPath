...
function typeColor(type: ListeningTaskType, c: ReturnType<typeof getColors>) {
  switch (type) {
    case "announcement": return c.primary;
    case "phone_message": return c.secondary;
    case "dialogue": return c.tertiary;
    case "radio_snippet": return c.primaryContainer;
    case "instructions": return c.onSurfaceVariant;
  }
}
        ...
        {daysUntilExam !== null && daysUntilExam > 0 && (
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ width: 40, height: 40, borderRadius: 9999, background: c.primaryFixed, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span className="mso" style={{ color: c.primary, fontSize: 20 }}>edit_calendar</span>
              </div>
              <div>
            ...
            <Link href="/profile" aria-label="Bewerk examendatum">
              <span className="mso" style={{ color: c.primary, fontSize: 20 }}>edit</span>
            </Link>
          </div>
        )}
              ...
              <div key={week} style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ fontSize: 10, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.2em", color: isLocked ? c.onSurfaceVariant : c.primary }}>
                      Week {week}
                    </span>
                        ...
                        <div style={{
                          ...
                          <div style={{ width: "calc(50% - 40px)", textAlign: "right", paddingRight: 12 }}>
                            ...
                            {isCompleted && task.best_score !== null && (
                              <p style={{ fontSize: 10, color: c.primary, margin: 0, marginTop: 2, fontWeight: 700 }}>
                                {task.best_score}%
                              </p>
                            )}
                          </div>
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 24 }}>
                  {[
                    ...
                    { label: "Vragen", value: `${selectedTask.questions?.length ?? 0}` },
                    { label: "Herluister", value: `${selectedTask.allow_replays}×` },
                  ].map((item, i) => (
                    <div key={i} style={{
                ...
                {!selectedTask.audio_url && (
                  <div style={{
                    ...
                    padding: 12, borderRadius: 12, fontSize: 12, fontWeight: 600, marginBottom: 16, textAlign: "center",
                  }}>
                    Audio nog niet gegenereerd. Run scripts/generate-listening-audio.ts.
                  </div>
                )}
                ...
                <Link
                  ...
                  style={{
                    ...
                    background: selectedTask.audio_url
                      ? `linear-gradient(to bottom, ${c.primary}, ${c.primaryContainer})`
                      : c.surfaceHighest,
                    color: selectedTask.audio_url ? "#ffffff" : c.onSurfaceVariant,
                    pointerEvents: selectedTask.audio_url ? "auto" : "none",
